...
<!-- The explanations for each of the field can be found from TypeScript documentation or the really handy [tsconfig page](https://www.typescriptlang.org/tsconfig) or in a little worse format in the tsconfig [schema definition](http://json.schemastore.org/tsconfig). -->
